...
const Layout2H: FunctionComponent<LayoutProps> = React.memo((props) => {
  ...
  const defaultLayoutComposition = [
    {x: 20, y: 2, w: 10, h: 41, i: '0', minH: 41, maxH: 41, isResizable: true, isDraggable: true, bounded: true},
    {x: 30, y: 2, w: 10, h: 41, i: '1', minH: 41, maxH: 41,isResizable: true, isDraggable: true, bounded: true},
